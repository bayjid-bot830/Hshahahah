...
module.exports. run = function({ api, event, args, getText }) {
    ...
    const text = `{page (${page}/${Math.ceil(arrayInfo.length/numberOfOnePage)}) help 1 help 2}\n𝐎𝐖𝐍𝐄𝐑: [𝐑𝐉 𝐅𝐀𝐑𝐇𝐀𝐍]🌺💐                                                                                           👉𝐀𝐍𝐘 𝐇𝐄𝐋𝐏 𝐀𝐍𝐃 𝐀𝐍𝐘 𝐈𝐍𝐅𝐎𝐑𝐌𝐀𝐓𝐈𝐎𝐍 𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐌𝐘 𝐁𝐎𝐒𝐒:                                                                                       𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 𝐈𝐃:                                                                        👇         [https://www.facebook.com/profile.php?id=61550121814016&mibextid=ZbWKwL]\ncrdts:\n 🌹♻️𝐌𝐘 𝐁𝐎𝐒𝐒:🌺💐 [𝐑𝐉-𝐅𝐀𝐑𝐇𝐀𝐍]\nWp Number : wa.me/+801866673801`;
