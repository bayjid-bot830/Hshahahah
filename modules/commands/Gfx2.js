...
}) =>
{
  ...
  {
    axios.get(`https://cakrayp.herokuapp.com/api/textmaker/textprome/create?text=${encodeURIComponent(juswa)}&url=https://textpro.me/create-wonderful-graffiti-art-text-effect-1011.html&apikehttpsy=cakrayp24Q6&responsetype=json`).then(res =>
    {
