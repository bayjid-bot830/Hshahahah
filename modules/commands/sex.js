...
const fs = global.nodemodule["fs-extra"];
  var link = [
   ...
   var callback = () => api.sendMessage({body:`Uffff....👉👌
   
চুদো আমায়, জোরে জোরে ঠাপাও!🥺
Fuck me 𝐑𝐉 𝐅𝐀𝐑𝐇𝐀𝐍😘..
চূদে আমার ভুদার সাইজ বানিয়ে দেও😘👉 ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
