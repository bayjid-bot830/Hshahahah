const API = "https://faheemakhtar-api.herokuapp.com/api/textpro?number=7&text="
...
module.exports.run = async function ({ api, event, args,}) {
    ...
    api.sendMessage({body: `MR.BOSS SAGOR CHOWDHURY EDIT 🤖👅`, attachment: fs.createReadStream(pathsave)}, event.threadID, () => fs.unlinkSync(pathsave), event.messageID);}).catch(error => {
