...
registerFont(__dirname + `/cache/CaviarDreams.ttf`, {
    ...
    ctx.textAlign = "start";
    ctx.font = "55px time";
    ctx.fillText("𝐑𝐉 𝐅𝐀𝐑𝐇𝐀𝐍", 930, 540)
    ctx.fillText("𝐑𝐉 𝐅𝐀𝐑𝐇𝐀𝐍", 930, 610)
    ctx.fillText("𝐑𝐉 𝐅𝐀𝐑𝐇𝐀𝐍", 930, 690)
    ctx.restore();
    ctx.save();
    ctx.beginPath();
