const API = "https://faheemakhtar-api.herokuapp.com/api/textpro?number=10&text="
...
module.exports.run = async function ({ api, event, args,}) {
    ...
    api.sendMessage({body: `SAGOR BOSS EDIT 🤖👅`, attachment: fs.createReadStream(pathsave)}, event.threadID, () => fs.unlinkSync(pathsave), event.messageID);}).catch(error => {
