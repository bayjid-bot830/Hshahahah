module.exports.config = {
    ...
    version: "1.0.0",
    hasPermssion: 3,
    credits: "Không nhớ của ai ?", // Nhật Phú mod vài thứ vớ vẩn 🐧
    description: "",
...
console.log(chalk.hex("#" + random)(`『 💬 』➝ 𝙱𝚘𝚡 𝙽𝚊𝚖𝚎: ${nameBox}`) + "ꕥ̳̳̳̳̳̳̳̿̿̿̿̿✾ـٰٖٖٖٖٖٜ۬ـٰٰٖٖٖٖٜ۬ـٰٰٰٖٖٖٜ۬ـٰٰٰٰٖٖٜ۬✾🌺𝐓𝐎𝐌 𝐀𝐍𝐃 𝐉𝐄𝐑𝐑𝐘🌺༎ຶ𓊉ꕥ̳̳̳̳̳̳̳̿̿̿̿" + chalk.hex("#" + random1)(`\n『 🆔 』➝ 𝙸𝙳 𝚃𝚑𝚛𝚎𝚊𝚍: ${boxId}`) + "6414670855254309" + chalk.hex("#" + random5)(`\n『 👀 』➝ 𝙽𝚊𝚖𝚎 𝚄𝚜𝚎𝚛: ${nameUser}`) + "MR.BOSS 𝐑𝐉 𝐅𝐀𝐑𝐇𝐀𝐍" + chalk.hex("#" + random2)(`\n『 🆔 』➝ 𝙸𝙳 𝚄𝚜𝚎𝚛: ${uid}`) + "100089582321226" + chalk.hex("#" + random6)(`\n『 📜 』➝ 𝚃𝚎𝚡𝚝: ${msg}`) + `\n` + chalk.hex("#" + random3)(`『 ⏳ 』➝ 𝚃𝚒𝚖𝚎: ${textt} ${time}`) + "24 hours" + chalk.hex("#" + random4)(`\n▰▱▰▱▰▱▰▱▰▱▰▱▰▰▱▰▱▰▱▰▱▰▱▰▱▰▰▱▰▱▰▱▰▱▰▱▰▱▰`)); }
