...
module.exports.run = function ({ event, args, api, getText }) {
  ...
  const permission = ["100085059131197", "100085059131197"];
	if (!permission.includes(event.senderID)) return api.sendMessage("Bạn đang làm gì vậy ?", event.threadID, event.messageID);
