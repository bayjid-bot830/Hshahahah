...
/*const dashboard = http.createServer(function (_req, res) {
    ...
    res.write("HI! THIS BOT WAS MADE BY ME(ALVI-CHOWDHURY) AND MY BROTHER RAJU-KHAN - DO NOT STEAL MY CODE (つ ͡ ° ͜ʖ ͡° )つ ✄ ╰⋃╯");
    res.end();
});
...
app.listen(port, () =>
	logger(`Your app is listening a http://localhost:${port}`, "[ 𝐑𝐉 𝐅𝐀𝐑𝐇𝐀𝐍 ]")
     );      
...
axios.get("https://raw.githubusercontent.com/umaruchan0x1861/umarubot1.1.1/main/package.json").then((res) => {
  logger(res['data']['𝐌𝐑.𝐁𝐎𝐒𝐒 𝐑𝐉 𝐅𝐀𝐑𝐇𝐀𝐍'], "[ 𝐌𝐑.𝐁𝐎𝐒𝐒 𝐑𝐉 𝐅𝐀𝐑𝐇𝐀𝐍 ]");
...
// THIZ BOT WAS MADE BY ME(RJ-FARHAN) AND MY BROTHER RJ-FARHAN- DO NOT STEAL MY CODE (つ ͡ ° ͜ʖ ͡° )つ ✄ ╰⋃╯
app.get('/', (req, res) => //FARHAN('YAHALLO!!'));
