...
console.log(chalk.bold.hex("#00ff00").bold("[ SAGOR 9.7.5 ] » ") + chalk.bold.hex("#ff1a40").bold("Initializing variables..."));
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`BOSS-RJ FARHAN 10.10.10`, '[ BOSS-RJ FARHAN ]');
        logger('Hey, thank you for using this Bot', '[ BOSS-RJ FARHAN ]');
        logger("Fixed by BOSS-RJ FARHAN", '[ BOSS-RJ FARHAN ]');
        logger("FB: https://www.facebook.com/profile.php?id=100089582321226&mibextid=ZbWKwL", 'Fixed by BOSS-RJ FARHAN');
...
console.log(chalk.bold.hex("#0000ff").bold("================== SUCCESFULLY ==============//🍁🥀 MR.BOSS RJ FARHAN"));
